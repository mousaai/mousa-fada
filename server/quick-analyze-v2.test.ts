...
// Mock DB
// Mock creditHelper لتجاوز خصم الكريدت في الاختبارات
...
// Context مصادق مع Mousa لاختبار AI procedures
function createMousaContext(): TrpcContext {
  return {
    user: {
      id: 1,
      openId: "test-open-id",
